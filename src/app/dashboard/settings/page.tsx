...
import {
  ...
  Loader2, ExternalLink, Palette, Eye
} from "lucide-react";
        ...
        <div className="max-w-md animate-fade-in">
          <div className="glass-card p-6">
            ...
            <div className="bg-white p-6 rounded-2xl mb-5 flex items-center justify-center">
              <div className="w-48 h-48 bg-dark-900 rounded-lg flex items-center justify-center">
                <QrCode size={80} className="text-dark-200" />
              </div>
            </div>

            <div className="space-y-3">
              <div className="p-3 bg-dark-900 rounded-xl text-xs text-dark-300 font-mono break-all">
                https://stampify.app/c/{biz.id}/join
              </div>
              <button className="w-full btn-primary flex items-center justify-center gap-2">
                <Download size={16} />
                Télécharger PDF (10×10cm)
              </button>
            ...
            <div className="mt-5 p-3 bg-dark-900/50 border border-white/5 rounded-xl text-xs text-dark-400">
              💡 Imprimez ce QR code et collez-le sur votre comptoir ou à l'entrée. Vos clients le scannent pour s'inscrire automatiquement.
            </div>
          </div>
        </div>
      )}
